...
// Exit if Own_Store_Radio_Image_Control exists and WP_Customize_Control does not exsist.
if ( class_exists('Own_Store_Radio_Image_Control') && ! class_exists( 'WP_Customize_Control' ) ) :
	return null;
endif;
 ...
 * @access public
 */
class Own_Store_Radio_Image_Control extends WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'own-store-radio-image';
	...
	public function enqueue() {
        ...
        wp_enqueue_style( 'own-store-radio-image-control-css', trailingslashit(get_stylesheet_directory_uri()) . 'inc/customizer/custom-controls/radio-images/radio-image.min.css', array(), '1.0', 'all' );
	}
